...
use MiniLeanpub\Application\UseCases\Book\ConvertBookToPDF\DTO\{ConvertBookToPDFInputDTO, ConvertBookToPDFOutputDTO};
...
{
    public function test_should_send_a_book_to_convert_to_pdf_via_use_case()
    {
